...
public class BookedTrip {
    ...
    public void generateBoardingPass() throws IOException {
        ...
        String pathToFile = "src/main/java/com/main/boardingpass/boardingPasses/" + boardingNumber;
        try {
    ...
    public String getBoardingPass() {
        try {
            return FileUtils.readFileToString(new File("src/main/java/com/main/boardingpass/boardingPasses/" + boardingNumber), "utf-8");
        } catch (IOException e) {
            return e.toString();
        }
    }
